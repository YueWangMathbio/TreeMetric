...
def d(T1,T2): # calculate the distance between two trees with depth 0
    if T1==T2:
        return 0
    else:
        return 1
...
def BM(n,T1,T2): 
    ...
    if n==0:
        return d(T1,T2) # if depth is 0, directly use the d function
    else:
        m=2**n-1 # number of vertices in each subtree
...
T2="yyxyyxy"
T3="zzxxzyy"
print('D_BM(T1,T2)=',BM(2,T1,T2))
print('D_BM(T1,T3)=',BM(2,T1,T3))
print('D_BM(T2,T3)=',BM(2,T2,T3))
print('')

T4="xxxnnnn"
T5="xyynnnn"
T6="xzzzzzz"
print('D_BM(T4,T5)=',BM(2,T4,T5))
print('D_BM(T4,T6)=',BM(2,T4,T6))
print('D_BM(T5,T6)=',BM(2,T5,T6))
print('')
...
print('D_BM(T7,T8)=',BM(4,T7,T8))
print('D_BM(T7,T9)=',BM(4,T7,T9))
print('D_BM(T7,T10)=',BM(4,T7,T10))
print('D_BM(T7,T11)=',BM(4,T7,T11))
print('D_BM(T8,T9)=',BM(4,T8,T9))
print('D_BM(T8,T10)=',BM(4,T8,T10))
print('D_BM(T8,T11)=',BM(4,T8,T11))
print('D_BM(T9,T10)=',BM(4,T9,T10))
print('D_BM(T9,T11)=',BM(4,T9,T11))
print('D_BM(T10,T11)=',BM(4,T10,T11))
print('')

TA="wxwwwwwwzzsszzz"
TS="xxwxxwxxxwwwwww"
print('D_BM(TA,TS)=',BM(3,TA,TS))
